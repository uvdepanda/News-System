...
include("../controller/news_entry.php");
...
<html lang="en">
    ...
    <div class="container">
      <div class="row cms">
        ...
        <div class="welcomeAdmin">News Entry</div>
          ...
          <div class="admin_right">
            <form class="form-horizontal" name="news_entry" role="form" method="POST" action="" onSubmit="multipart/form-data" >
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="headline" name="headline" placeholder="Enter News Headline">
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-2" for="date">Date:</label>
                <div class="col-sm-10">
                  <input type="date" class="form-control" id="date" name="date" placeholder="Enter Date of Publication">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" id="news" name="news" rows="15" cols="60" ></textarea>
                </div>
              </div>
              <div class="form-group">
